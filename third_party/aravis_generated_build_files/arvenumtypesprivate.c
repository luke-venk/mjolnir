...
GType arv_gvsp_packet_status_get_type(void)
{
  static gsize gtype_id = 0;
  static const GEnumValue values[] = {
...
GType arv_gvsp_content_type_get_type(void)
{
  static gsize gtype_id = 0;
  static const GEnumValue values[] = {
      {C_ENUM(ARV_GVSP_CONTENT_TYPE_UNKNOWN), "ARV_GVSP_CONTENT_TYPE_UNKNOWN", "unknown"},
...
//       {C_ENUM(ARV_UVSP_PAYLOAD_TYPE_IMAGE_EXTENDED_CHUNK), "ARV_UVSP_PAYLOAD_TYPE_IMAGE_EXTENDED_CHUNK", "image-extended-chunk"},
//       {C_ENUM(ARV_UVSP_PAYLOAD_TYPE_CHUNK), "ARV_UVSP_PAYLOAD_TYPE_CHUNK", "chunk"},
//       {C_ENUM(ARV_UVSP_PAYLOAD_TYPE_GENDC_CONTAINER), "ARV_UVSP_PAYLOAD_TYPE_GENDC_CONTAINER", "gendc-container"},
//       {C_ENUM(ARV_UVSP_PAYLOAD_TYPE_GENDC_COMPONENT_DATA), "ARV_UVSP_PAYLOAD_TYPE_GENDC_COMPONENT_DATA", "gendc-component-data"},
//       {0, NULL, NULL}};
//   if (g_once_init_enter(&gtype_id))
//   {
